...
func TestRollup(t *testing.T) {
	...
	mintAddr := utils.EvmToCosmosAddress("cosmos", from)
	recipientAddr := utils.EvmToCosmosAddress("cosmos", *depositTx.To())
	...
	require.Equal(t, math.ZeroInt(), queryUserERC20Balance(t, queryClient, utils.EvmToCosmosAddress("cosmos", erc20userAddr), erc20tokenAddr, integrationApp))
	...
	require.Equal(t, erc20depositAmount, queryUserERC20Balance(t, queryClient, utils.EvmToCosmosAddress("cosmos", erc20userAddr), erc20tokenAddr, integrationApp).BigInt())
