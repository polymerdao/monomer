...
// Source: github.com/polymerdao/monomer/x/rollup/types (interfaces: BankKeeper)
//
// Generated by this command:
//
//	mockgen -destination ../testutil/expected_keepers_mocks.go -package=testutil . BankKeeper
//
