...
SHA=$(jq -r .foundry < "$MONOMER_DIR"/versions.json)

# All code below this comment is copied from the original optimism/ops/scripts/install-foundry.sh
# script at commit 24a8d3e0
