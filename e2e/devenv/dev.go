...
func openLogFile2(t *testing.T, env *environment.Env, name string) *os.File {
...
func Main(t *testing.T) {
	...
	log.SetDefault(log.NewLogger(log.NewTerminalHandler(openLogFile2(t, env, "root-logger"), false)))

	opLogger := log.NewTerminalHandler(openLogFile2(t, env, "op"), false)
