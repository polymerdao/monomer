...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/joshklop/cosmos-sdk v0.0.0-20240515195711-999685ee9f30
	// use latest golang.org/x/exp/slices api
	github.com/cosmos/gogoproto => github.com/polymerdao/gogoproto v0.0.0-20230905135849-dbeac9fa0743

	github.com/ethereum/go-ethereum => github.com/ethereum-optimism/op-geth v1.101315.1-rc.1
)
