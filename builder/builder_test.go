...
func TestWithdrawalMessages(t *testing.T) {
	...
	checkDepositTXResult(t, txStore, depositTx, expectedDepositAmount, cosmAddr.String())
...
func checkDepositTXResult(t *testing.T, txStore txstore.TxStore, depositTx bfttypes.Txs, expectedDepositAmount, cosmAddr string) {
